...
CORE = (
    ...
    "Excerpt headers read '[doc_id, p. N — FP<n>, B.x, year]': the id and\n"
    "the page are the citation; name a proposal by its FP<n>, cite it by\n"
    "the id. The bracket format is identical in every language.\n"
